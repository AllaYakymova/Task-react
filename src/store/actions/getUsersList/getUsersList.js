import { REQUEST_USERS_SUCCESS, REQUEST_USERS_IN_PROCESS, REQUEST_USERS_ERROR} from "../../constants";
import axios from "axios";


const getUsersSuccess = usersList => ({ type: REQUEST_USERS_SUCCESS, payload:  [...usersList] });
